          ...
          <div className="w-full max-w-md mb-5 animate-slide-up">
            <div className="bg-amber-500/15 border border-amber-400/30 rounded-xl p-4 text-amber-100">
              <div className="flex items-start gap-3">
                ...
                <button onClick={() => setShowAviso(false)} className="text-amber-300/60 hover:text-amber-200 text-lg leading-none flex-shrink-0">×</button>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-end">
                <button type="button" className="text-xs text-clinical-600 hover:text-clinical-700 font-medium">
